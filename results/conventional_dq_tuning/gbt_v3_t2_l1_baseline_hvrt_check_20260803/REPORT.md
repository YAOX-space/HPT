...
Run directory: `E:\research_space\Hybrid-power-transformer\results\conventional_dq_tuning\gbt_v3_t2_l1_baseline_hvrt_check_20260803`

## Ranked Candidates

| rank | topology | candidate | valid | L1 pass | L2 | L3 | score_sum | load-quality max | recovery max | vdc_min | vdc_max | csv |
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | topology2 | t2_currentgate_vff000_reg060_energyoff | 1/1 | 0/1 | 0 | 0 | 107.360 | 0.000000 | 0.000000 | 799.483 | 1038.401 | `control_comparison_topology2_fault_all_gbt_v3_t2_l1_baseline_hvrt_check_20260803_topology2_t2_currentgate_vff000_reg060_energyoff_20260803_210538.csv` |
